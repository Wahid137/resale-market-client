        ...
        <div className="hero min-h-screen" style={{ backgroundImage: `url(${cycle4})` }}>
            ...
            <div className="hero-content text-center text-neutral-content">
                <div className="max-w-2xl">
                    <h1 className="mb-5 text-5xl font-bold font-serif leading-4" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500" d>Choose Your Bike From Larana Bike Store</h1>
