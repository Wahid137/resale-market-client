        ...
        <div className='overflow-hidden'>
            <div className="hero py-20 bg-info">
                <div className=" hero-content flex-col lg:flex-row-reverse" >
                    <img src={infobike} data-aos="fade-left" data-aos-duration="1500" className="max-w-xl rounded-lg shadow-2xl  " alt="" />
                    <div className='w-1/2' data-aos="fade-right" data-aos-duration="1500">
                        <h1 className="text-5xl font-bold font-serif hover:bg-sky-700 ">Enjoy The Ride</h1>
