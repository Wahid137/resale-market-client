            ...
            <div className="hero py-20 ">
                <div className="hero-content z-auto flex-col lg:flex-row-reverse" >
                    ...
                    <div className='w-1/2' data-aos="fade-right" data-aos-duration="1500">
                        ...
                        <p className="py-6 font-serif text-justify me-5">Hand cycles are similar to recumbent tricycles, but they are powered with hand instead of foot pedals. Velcro straps can be used to secure the hands to the pedals if necessary.</p>
                    </div>
                </div>
            </div>
