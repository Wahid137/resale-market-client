...
const Info = () => {
    ...
    return (
        <div className="hero overflow-hidden py-20 bg-info ">
            <div className=" hero-content flex-col lg:flex-row-reverse" style={{ backgroundImage: `url(${infobike})` }}>
                <img src={infobike} data-aos="fade-left" data-aos-duration="1500" className="max-w-lg rounded-lg shadow-2xl" alt="" />
                <div className='w-1/2 text-white' data-aos="fade-right" data-aos-duration="1500">
