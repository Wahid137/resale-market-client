...
const Info = () => {
    ...
    return (
        <div className='overflow-hidden'>
            <div className="hero min-h-screen py-20 bg-info">
                <div className=" hero-content flex-col lg:flex-row-reverse" >
                    <img src={infobike} data-aos="fade-left" data-aos-duration="1500" className="max-w-md rounded-lg shadow-2xl hover:scale-110 " alt="" />
                    <div className='w-1/2 pr-32' data-aos="fade-right" data-aos-duration="1500">
