    ...
    return (
        <div className='overflow-hidden bg-info'>
            <div className="hero py-20 ">
                <div className=" z-auto flex-col lg:flex-row-reverse" >
                    <div className='-z-1 transition transform hover:scale-110'>
                        <img src={infobike} data-aos="fade-left" data-aos-duration="1500" className="max-w-xl rounded-lg shadow-2xl ms-5 hover:scale-110" alt="" />
                    </div>
