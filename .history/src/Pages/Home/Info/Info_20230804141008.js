...
const Info = () => {
    ...
    return (
        <div className='overflow-hidden bg-warning'>
            <div className="hero py-20 ">
                <div className="hero-content z-auto flex-col lg:flex-row-reverse" >
                    <div className='transition hover:scale-110'>
                        <img src={infobike} data-aos="fade-left" data-aos-duration="1500" className="lg:max-w-xl rounded-lg shadow-2xl lg:ms-10" alt="" />
                    </div>
            ...
            <div className='text-center mb-10' data-aos="flip-right" data-aos-duration="1500">
