        ...
        <div className='bg-white overflow-hidden rounded-lg shadow-md hover:shadow-xl'>
            ...
            <div className='px-6 py-4'>
                ...
                <hr className="h-px my-4 bg-gray-200 border-0 dark:bg-gray-900"></hr>
                {
                    ...
                    user?.type === 'verified' && <div className='flex  justify-center'>
                        <p className=' text-xl mb-2 text-center'>Seller Name: {user?.name}</p><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-green-500 ms-1">
