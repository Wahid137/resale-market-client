            ...
            <div className='px-6 py-4'>
                ...
                <p className=' text-xl mb-2 text-center'>Seller Name: {user.name}</p>
                {
                    ...
                    user?.type === 'verified' && <div className='flex items-center'>
                        <p className='text-green-500'>Seller Name: {user?.name}</p><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-green-500 ms-1">
