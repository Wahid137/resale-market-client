                ...
                <form className=" w-[500px] p-10" onSubmit={handleSubmit(handleLogin)}>
                    ...
                    <div className='flex ms-2 my-5'>
                        ...
                        <div className="items-center flex me-20">
                            <input type="radio" value="buyer" onChange={e => setUser(e.target.value)} name="buyer" className="radio" checked={user === "buyer"} />
                            <span className="label-text">Buyer</span>

                        </div>
                        <div className="items-center flex">
                            <input type="radio" value="seller" onChange={e => setUser(e.target.value)} name="seller" className="radio" checked={user === "seller"} />
