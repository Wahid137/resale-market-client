        ...
        <div className="flex justify-center items-center h-[740px] bg-teal-50">
            <div className='card shadow-xl'>
                <form className=" w-[500px] p-10" onSubmit={handleSubmit(handleLogin)}>
                    <h2 className='text-xl font-bold mb-12 text-center'>Login</h2>
                    <div className="form-control w-full mb-5">

                        <input type="text"
                            {...register("email", { required: "Email Address is required" })}
                            className="border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-teal-600 focus:ring-0 border-0 w-full h-10"
