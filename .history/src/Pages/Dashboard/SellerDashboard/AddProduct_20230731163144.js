        ...
        <div className='p-7'>
            ...
            <div className=" flex justify-center items-center bg-teal-50 p-10">
                <div className='card shadow-xl bg-white'>
                    <form className=" p-10 w-[700px]" onSubmit={handleSubmit(handleAddProduct)}>
                        ...
                        <div className="form-control w-full mb-8 relative flex flex-row">
                            <label htmlFor="">Time when you posted</label>
                            <input type="date"
