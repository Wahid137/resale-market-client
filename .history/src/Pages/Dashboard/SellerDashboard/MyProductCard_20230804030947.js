...
const MyProductCard = ({ product, refetch }) => {
    ...
    const handleUpdateProduct = product => {
        fetch(`https://resale-market-server-wahid137.vercel.app/dashboard/advertise/${product._id}`, {
            method: 'PUT',
            headers: {
        ...
        <div className='bg-white overflow-hidden rounded-lg shadow-md hover:shadow-xl'>
            ...
            <div className='p-2'>
                ...
                <div className='flex flex-col pb-2'>
                    ...
                    <label onClick={() => setUpdateProduct(product)} htmlFor="confirmation-modal" className='btn btn-sm  w-1/2 mx-auto btn-secondary '>Advertise</label>
                </div>
            </div>
            {
