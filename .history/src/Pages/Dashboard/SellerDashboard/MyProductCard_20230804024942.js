        ...
        <div className='bg-white overflow-hidden rounded-lg shadow-md hover:shadow-xl'>
            ...
            <div className='p-2'>
                ...
                <div className='flex flex-col justify-center'>
                    <label onClick={() => setDeletingUser(product)} htmlFor="confirmation-modal" className='btn btn-sm w-1/2 mx-auto btn-secondary mb-2'>Delete</label>
                    <label onClick={() => setDeletingUser(product)} htmlFor="confirmation-modal" className='btn btn-md  w-1/2 mx-auto btn-secondary '>Advertised</label>
                </div>
            </div>
            {
