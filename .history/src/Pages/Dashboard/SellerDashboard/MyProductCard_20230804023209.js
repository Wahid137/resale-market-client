        ...
        <div className='bg-white overflow-hidden rounded-lg shadow-md hover:shadow-xl'>
            ...
            <div className='p-2'>
                ...
                <div className='flex justify-center pb-2'>
                    <label onClick={() => setDeletingUser(product)} htmlFor="confirmation-modal" className='btn btn-md btn-secondary '>Delete</label>
                    <label onClick={() => setDeletingUser(product)} htmlFor="confirmation-modal" className='btn btn-md btn-secondary '>Advertised Item</label>
                </div>
            </div>
            {
