    ...
    return (
        <div className='bg-white overflow-hidden rounded-lg shadow-md hover:shadow-xl'>
            ...
            <div className='p-2'>
                ...
                <hr className="h-px my-4 bg-gray-200 border-0 dark:bg-gray-900"></hr>
                <div className='flex flex-col justify-center btn-sm'>
                    <label onClick={() => setDeletingUser(product)} htmlFor="confirmation-modal" className='btn btn-sm  btn-secondary mb-2'>Delete</label>
                    <label onClick={() => setDeletingUser(product)} htmlFor="confirmation-modal" className='btn btn-sm  btn-secondary '>Advertised</label>
                </div>
            </div>
            {
