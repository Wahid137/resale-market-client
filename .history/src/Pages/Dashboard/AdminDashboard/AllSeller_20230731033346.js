                    ...
                    <tbody className=''>
                        {
                            users.map((user, i) => <tr key={user._id}>
                                ...
                                <td>
                                    ...
                                    {
                                        user?.type === 'verified' && <p className='text-green-500'>Verified<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
