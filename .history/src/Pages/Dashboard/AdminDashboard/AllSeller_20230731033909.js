                                ...
                                <td>
                                    ...
                                    }
                                    {
                                        user?.type === 'verified' && <div className='flex items-center'>
                                            <p className='text-green-500'>Verified</p><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 text-green-500">
